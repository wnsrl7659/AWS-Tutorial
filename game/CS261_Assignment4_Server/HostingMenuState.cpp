...
void HostingMenuState::Update()
{
	...
	if (res > 0)
	{
		...
		//default configuration.secret is CS261S20. need to get correct argv ?? 
		calculated_token = client_username + client_avatar + client_game_type + "CS261S21";//+ configuration_.secret;
